/****************************************************************
 *
 * $Source: /pv/CvsTree/pv/gen/src/prg/methods/NSPECT/loadMeth.c,v $
 *
 * Copyright (c) 1999
 * BRUKER MEDICAL GMBH
...
static const char resid[] = "$Id: loadMeth.c,v 1.1 2005/08/16 14:51:29 dwe Exp $ (C) 1999 BRUKER MEDICAL";
...
/*:=MPE=:=======================================================*/
{
  DB_MSG(( "Entering einpuls:loadMeth( %s )", className ));
  ...
  DB_MSG(( "Exiting einpuls:loadMeth( %s )", className ));
}
